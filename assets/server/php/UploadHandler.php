...
/*
            'script_url' => 'https://www.crypt2share.com/app/server/php/',//$this->get_full_url().'/',
            'upload_dir' => '/home/crypt2/public_html/app/homes/'.$_SESSION['username'].'/files/',//dirname($_SERVER['SCRIPT_FILENAME']).'/files/',
            'upload_url' => 'https://www.crypt2share.com/app/homes/'.$_SESSION['username'].'/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
 ...
 */
    ...
    function __construct($options = null, $initialize = true) {
		session_start();
		if (!isset($_SESSION['up_path']))
		 $_SESSION['up_path'] = 'files';
        $this->options = array(
            'script_url' => $_SESSION['site_address'].'server/php/',//$this->get_full_url().'/',
            'upload_dir' => $_SESSION['path'].$_SESSION['username'].'/' . $_SESSION['up_path'] . "/",//dirname($_SERVER['SCRIPT_FILENAME']).'/files/',
            'upload_url' => $_SESSION['site_address'] . 'homes/'.$_SESSION['username'].'/' . $_SESSION['up_path'] . "/",
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            // Set the following option to 'POST', if your server does not support
            ...
            'accept_file_types' => '/.+$/i',
            'exclude_file_types' => '/\.('.$_SESSION['kc_denied_ext'].')$/i',
            // The php.ini settings upload_max_filesize and post_max_size
            // take precedence over the following max_file_size setting:
            'max_file_size' => $_SESSION['max_file_size'],
            'min_file_size' => 1,
            // The maximum number of files for the upload directory:
            'max_number_of_files' => $_SESSION['max_number_of_files'],
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        if (preg_match($this->options['exclude_file_types'], $file->name)) {
            $file->error = 'Estensione non permessa';//$this->get_error_message('accept_file_types');
            return false;
        }
