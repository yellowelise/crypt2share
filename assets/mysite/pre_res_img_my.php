...
if (!file_exists($_SESSION['app_path']."cache/"))
  ...
  $cachedfile = $_SESSION['app_path']."cache/" .sha1($filename) . "_" . $thumbnailsize ."px_".$c ."_". $w."x".$h."_". sha1($_SESSION['username']) . "." . $ext;
 // echo $cachedfile . "<br />";
	...
	if (isset($_REQUEST['dwn']))
		{
		   ...
		   header('Content-Disposition: attachment; filename="' . basename($cachedfile).'"');
