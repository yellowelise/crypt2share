...
$json["message"] = "OK";
$json["file"]["filename"] = basename($target_path);
$json["file"]["dir"] = $d;
$json["file"]["size"] = filesize($target_path);
$json["file"]["human_size"] = format_size($json["file"]["size"]);

} else{
$json["message"] = "Errore caricando il file";
