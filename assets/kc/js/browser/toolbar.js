...
browser.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:friendship"]').click(function() {
       friendship();
       return false;
    });

    $('#toolbar a[href="kcact:invita"]').click(function() {
       invita();
       return false;
    });
    $('#toolbar a[href="kcact:crypted"]').click(function() {
       show_hide_crypted();
       return false;
    });

    $('#toolbar a[href="kcact:mysite"]').click(function() {
       show_mysite();
       return false;
    });

    $('#toolbar a[href="kcact:notify"]').click(function() {
       view_notify();
       return false;
    });
...
browser._initUploadButton = function() {
...
browser._uploadFile = function(form) {
    if (!this.dirWritable) {
    ...
    $.blockUI({ message: '<div id="loading" style="width:300px;"></div><a style="height:20px;" id="chiudi" href="javascript:close()"  onclick="return false"><img src="themes/oxygen/img/icons/close_j.png" style="vertical-align:middle"></a><br /><iframe style="width:100%;height:90%;" src="http://www.baptistebrunet.com/games/fruit_salad/"></iframe><br /><a style="height:20px;" id="chiudi_l" href="javascript:close()"  onclick="return false"><img src="themes/oxygen/img/icons/close_j.png" style="vertical-align:middle"></a>', css: { 
...
browser.uploadFile = function(form) {
    ...
    $.blockUI({ message: '<div id="loading" style="width:300px;"></div><a style="height:20px;" id="chiudi" href="javascript:close()"  onclick="return false"><img src="themes/oxygen/img/icons/close_j.png" style="vertical-align:middle"></a><br /><div id="uploadStatus" style="border:1px solid black;">Upload status...</div><br /><a style="height:20px;" id="chiudi_l" href="javascript:close()"  onclick="return false"><img src="themes/oxygen/img/icons/close_j.png" style="vertical-align:middle"></a>', css: { 
   		height: ($(window).height()-50) +'px',
		width: ($(window).width()-50) + 'px', 		
        top:  '25px', 
        left: '25px' 
