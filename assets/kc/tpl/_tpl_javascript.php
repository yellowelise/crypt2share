...
{
	var res = '<div style="width:100%;"><button id="tb_mts" onclick=moveto_secure(\'' + escape(d +'/'+ f)+'\') ><img src="../images/encrypt_ss.png"> Move to Secure</button>&nbsp;<button id="tb_fbs" onclick=fbs_click(\'' + escape(d +'/'+ f)+'\',\'Crypt2Share.com\') ><img src="../images/facebookshare.png"> Facebook share</button>&nbsp;<button id="tb_ctf" onclick=copy_to_friend(\'' + escape(d +'/'+ f)+'\') ><img src="../images/friends.png"> Copy to friend</button>&nbsp;</div>';
return res;
}
