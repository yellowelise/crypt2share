...
$lang = array(
    ...
    "Notify" => "Notifiche",
    "Friends" => "Amici",
    "Tell a friend" => "Invita Amici",
    "Insert folder name" => "Inserisci nome cartella",
    "New folder" => "Nuova cartella",
    "Waiting..." => "Attendere...",
    "Insert crypting password:" => "Inserisci la password di Criptaggio:",
    "Crypting" => "Cripta",
    "Insert decrypting password:" => "Inserisci password di decriptaggio:",
    "Decrypting" => "Decripta",
    "Delete file: " => "Eliminare il file: ",
    " permanently?" => " in maniera definitiva?",
    "Sharing file: " => "Condividi il file: ",
    "Tell a friend" => "Invita Amici",
    "Tell a friend" => "Invita Amici",
    "Tell a friend" => "Invita Amici",
    "Tell a friend" => "Invita Amici",
